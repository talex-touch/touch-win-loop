...
import { getProjectMemberManagementSnapshot, getVisibleProjectById } from '~~/server/utils/platform-store'
...
export default defineEventHandler(async (event) => {
  ...
  const snapshot = await withClient(event, async (db) => {
    ...
    return getProjectMemberManagementSnapshot(db, projectId)
  })
