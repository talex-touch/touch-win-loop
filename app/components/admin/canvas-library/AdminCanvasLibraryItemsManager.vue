...
const selectedAssetPreviewUrl = computed(() => {
  ...
  if (!itemId || !version || version.payloadType !== "binary_asset") return "";
  return endpoint(
...
const filteredRows = computed(() => {
  if (!filters.assetKind) return items.value;
      ...
      <div class="space-y-4">
        ...
        <div class="grid gap-3 md:grid-cols-2">
          ...
          <textarea
            ...
            class="min-h-[80px] rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 outline-none transition-colors focus:border-slate-300 md:col-span-2"
            placeholder="摘要"
          />
          <input
        ...
        <div v-if="createForm.mode === 'template'" class="space-y-3">
          <select
            ...
            class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 outline-none transition-colors focus:border-slate-300"
          >
            <option value="scene">
              scene
            </option>
          ...
          <textarea
            ...
            class="min-h-[260px] w-full rounded-lg border border-slate-200 bg-slate-950 px-3 py-3 font-mono text-xs leading-6 text-slate-100 outline-none transition-colors focus:border-slate-400"
        ...
        <div v-else class="space-y-3">
          ...
          <template v-if="createForm.assetKind === 'device_shell'">
            <textarea
              ...
              class="min-h-[88px] w-full rounded-lg border border-slate-200 bg-slate-950 px-3 py-3 font-mono text-xs leading-6 text-slate-100 outline-none transition-colors focus:border-slate-400"
    ...
    >
      ...
      <div v-else-if="editDetail" class="space-y-4">
        ...
        <div class="rounded-lg border border-slate-200 bg-slate-50 p-3">
          ...
          <div v-if="selectedAssetPreviewUrl" class="mt-3 rounded-lg border border-slate-200 bg-white p-3">
            <img :src="selectedAssetPreviewUrl" alt="" class="max-h-[320px] w-full rounded object-contain">
          </div>
          <pre
            v-else
            class="mt-3 overflow-auto rounded-lg border border-slate-200 bg-slate-950 px-3 py-3 text-xs leading-6 text-slate-100"
