...
it('WorkspaceLeftSidebar 已下沉为 rail + panel 壳层结构', async () => {
  ...
  assert.doesNotMatch(sidebarSource, /title="文档属性"/, 'WorkspaceLeftSidebar 仍内联资源详情弹窗')
  ...
  assert.match(resourceManagerSource, /title="文档属性"/, 'WorkspaceResourceManagerPanel 缺少资源详情弹窗')
