...
it('独立设备排布编辑器提供 shots.so 式模板、图片面板、自动排版与导出闭环', async () => {
  ...
  assert.match(devicePanel, /grid-template-columns: 288px minmax\(0, 1fr\) 336px/, '设备排布工作台未保持左模板、中预览、右图片三栏')
  assert.match(devicePanel, /data-testid="workspace-device-arrangement-template-panel"/, '独立设备排布编辑器缺少左侧模板面板')
