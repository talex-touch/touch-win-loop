...
it('答辩主区切成无 tabs 的比赛状态驾驶舱，并提供主动作入口', async () => {
  ...
  assert.match(source, /\.workspace-defense-workbench__corner-preview \{[\s\S]*position: sticky;[\s\S]*right: 24px;[\s\S]*bottom: 104px;[\s\S]*align-self: flex-end;[\s\S]*z-index: 11;/, '本地视频预览未 sticky 到答辩主栏右侧')
