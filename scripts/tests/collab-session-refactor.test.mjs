...
it('markdown 协作文档已切换为公共富文本编辑器，旧双栏预览已移除', async () => {
  ...
  assert.match(editorSource, /const selectionToolbarItems = computed\(\(\) => \{/, '公共编辑器未声明选区工具栏命令集')
  ...
  assert.match(editorSource, /preferredAbove >= 12[\s\S]*preferredBelow/s, '公共编辑器未优先将选区工具栏放到选区外侧')
